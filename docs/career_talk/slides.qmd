...
- All those skills valuable in industry/private sector
     - Particularly in tech where *lots of data gets collected*         
- Greater weight on coding skills with emphasis on SQL, R/Python programming, and basic Unix command line proficienc 
...
- Professional skills:	
    ...
    - Prioritisation and Time Management (“getting shit done”)
    - Navigating ambiguity
    - Networking  
...
- Udemy was not selling education products to students, it was selling teachers to students and students to teachers 
